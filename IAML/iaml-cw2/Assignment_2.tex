...
\\The values of the first four elements of the last training sample are also $[-3.14*10^{-6},-2.27*10^{-5},-1.18*10^{-4},-4.07*10^{-4}]$.
  ...
  \begin{answerbox}{52em}
    \includegraphics [ width=1\textwidth ]{1-2.png}
	 \\The images of the two closest samples to mean are very similar to the image of the mean vector, while the 
		images of the two furtherest samples to mean are very different from the image of the mean vector.
  \end{answerbox}
   ...
   \begin{subquestion}{(4 points)
      ...
      \begin{answerbox}{35em}
         \includegraphics [ width=1\textwidth ]{1-5.png}
			\\The images get more and more ambiguious because the ratio of variance explained gets smaller from the first component to the tenth component, yet 				they still show the overall pattern of each class.
      \end{answerbox}
   ...
   \begin{subquestion}{(4 points)
      ...
      \begin{answerbox}{40em}
         \includegraphics [ width=1\textwidth ]{1-8.png}
			\\Class 0,2,4,6 are relatively close to each other, as they all belong to the clothes' category; 
				Class 5,7,9 are relatively close to each other, as they all belong to the shoes' category; 
				Class 3 lies between Class 0,2,4,6 and Class 1, as Class 1 belongs to the pants' category and Class 3 belongs to the
				dress`s category, which includes features of both clothes and pants.
      \end{answerbox}
   ...
   \begin{subquestion}{(4 points)
      ...
      \begin{answerbox}{35em}
         \includegraphics [ width=1\textwidth ]{2-4.png}
				\\The points are classified into 10 classes, which is more than that in 2.3. The size and shape of the decision regions for
				each class are also different from those in 2.3. The decision boundaries are more convoluted than those in 2.3. Overall SVC does a
				better job than Linear Regression in classification.
      \end{answerbox}
  ...
  \medskip
   ...
   \begin{subquestion}{(3 points)
      ...
      \begin{answerbox}{35em}
         \includegraphics [ width=1\textwidth ]{3-2.png}
				\\The mean vectors are more concentrated while the cluster centers are sparser. This is because some samples with the same language
					do not necessarily belong to the same cluster. Samples of different languages may belong to the same cluster if they are relatively close to each other.
      \end{answerbox}
   ...
   \begin{subquestion}{(5 points)
      ...
      \begin{answerbox}{50em}
         \includegraphics [ width=0.6\textwidth ]{3-4-ward.png}
			\\ \includegraphics [ width=0.6\textwidth ]{3-4-single.png}
			\\ \includegraphics [ width=0.6\textwidth ]{3-4-complete.png}
         ...
         \includegraphics [ width=0.6\textwidth ]{3-5.png}
				...
				\begin{center}
					\begin{tabular}{ | c | c | c | c | c | c |} \hline
						----- & K=1 & K=3 & K=5 & K=10 & K=15 \\ \hline
						Full,Train & 16.4 & 18.1 & 19 & 21 & 22.8\\ \hline
						Full,Test & 15.8 & 17.1 & 16.5 & 14.6 & 11.8 \\ \hline
						Diagonal,Train & 14.3 & 15.4 & 16 & 16.9 & 17.5 \\ \hline
						Diagonal,Test & 13.8 & 15 & 15.9 & 16.6 & 16.9 \\ \hline
				\end{tabular}
			\end{center}
